...
def _extract_complementary_data(batch: dict[str, Any]) -> dict[str, Any]:
    ...
    This includes padding flags, task description, task_index/task_id, and indices.
    ...
    task_id_key = {"task_id": batch["task_id"]} if "task_id" in batch else {}  # Add task_id support
